...
.flow-table tr.selected:nth-child(even) {
    background-color: #c9dbed !important;
}
.flow-table tr.selected.highlighted {
    background-color: #7dbefc !important;
}
.flow-table tr.selected.highlighted:nth-child(even) {
    background-color: #5fb0fb !important;
}
.flow-table td {
    overflow: hidden;
    white-space: nowrap;
...
.flow-table td.col-comment,
.flow-table td.col-size,
.flow-table td.col-time,
.flow-table td.col-timestamp {
    text-align: right;
}
...
.flow-table tr:hover .col-quickactions {
    overflow: visible;
}
...
.certificate-table tr:not(:first-child),
.connection-table tr:not(:first-child),
.timing-table tr:not(:first-child) {
...
.headers .inline-input,
.trailers .inline-input {
    background-color: #fff;
}
.headers .kv-add-row,
.trailers .kv-add-row {
...
.headers:hover .kv-add-row,
.trailers:hover .kv-add-row {
    opacity: 1;
}
.connection-table td,
.timing-table td {
...
.dns-request table td,
.dns-request table th,
.dns-response table td,
.dns-response table th {
    padding-right: 1rem;
}
.flowview-image {
    text-align: center;
...
.modes .modes-category {
    padding-left: 10px;
}
.modes .green-left-border {
    border-left: 10px solid #77c77a;
}
.modes .gray-left-border {
...
.modes .mode-entry input[type="checkbox"] {
    margin: 0 10px;
    vertical-align: middle;
    width: 1.8rem;
    height: 1.8rem;
...
.modes .mode-local .processes-container {
    display: flex;
    flex-direction: row;
    align-items: center;
    gap: 5px;
...
.modes .mode-local .selected-processes {
    display: flex;
    flex-wrap: wrap;
    gap: 5px;
    overflow: hidden;
}
.modes .mode-local .selected-process {
    display: flex;
    flex-direction: row;
    gap: 5px;
...
.modes .mode-local .selected-process > i {
    font-size: 15px;
}
.modes .mode-local .dropdown-container {
    display: flex;
    flex-direction: row;
    align-items: center;
}
.modes .mode-local .local-dropdown {
    position: relative;
    width: 200px;
}
.modes .mode-local .local-dropdown .dropdown-header {
    padding: 5px;
    border: 1px solid #ccc;
    border-radius: 4px;
    cursor: pointer;
...
.modes .mode-local .local-dropdown input {
    border: none;
    flex: 1;
    outline: 0;
    color: #000;
}
.modes .mode-local .local-dropdown .dropdown-list {
    width: 100%;
    max-height: 300px;
    overflow-y: auto;
    z-index: 1;
...
.modes .mode-local .local-dropdown .dropdown-item {
    display: flex;
    flex-direction: row;
    align-items: center;
    padding: 8px 10px;
...
.modes .mode-local .local-dropdown .dropdown-item.selected {
    background-color: #e0e0e0;
}
.modes .mode-local .local-dropdown .dropdown-item:hover {
    background-color: #f0f0f0;
}
.modes .mode-local .local-dropdown .process-details {
    display: flex;
    flex-direction: row;
    align-items: center;
}
.modes .mode-local .local-dropdown .process-icon {
    margin-right: 5px;
    margin-left: 5px;
    color: #5f6368;
    width: 25px;
...
.modes .mode-local .local-dropdown .process-name {
    font-weight: 500;
    color: #333;
}
.modes .mode-local .local-dropdown .process-separator {
    margin-top: 10px;
    margin-bottom: 10px;
}
.modes .mode-local .local-popover button {
    font-size: 1rem;
}
.modes .mode-local .local-popover i {
    font-size: 1.5rem;
}
@supports (anchor-name: --test) {
    .modes .mode-local .local-popover > div {
        margin: 0;
        position: absolute;
        top: 10px;
...
.modes .mode-local .local-popover > div:popover-open {
    display: block;
}
.modes .mode-input {
    border: 1px solid #ccc;
...
.modes .mode-reverse-dropdown {
    margin: 0 5px;
    border: 1px solid #ccc;
    border-radius: 4px;
    height: 25px;
}
.modes .mode-reverse-servers {
    display: flex;
    flex-direction: column;
    gap: 10px;
}
.modes .mode-reverse-add-server {
    margin-left: 10px;
    display: flex;
    flex-direction: row;
    cursor: pointer;
...
.modes .mode-reverse-add-server:hover {
    opacity: 1;
}
.modes .mode-reverse-add-server i {
    font-size: 2rem;
    margin-right: 5px;
}
.modes .mode-popover > button {
...
.modes .mode-popover > div:popover-open {
    display: grid;
}
.modes .mode-popover > div > h4 {
    text-align: center;
    grid-column: 1 / -1;
}
.modes .mode-popover > div > .mode-input {
    text-align: right;
    background-color: #fff;
    margin: 0;
}
.modes .missing-mode-container {
    color: #b2b2b2;
}
.modes .missing-mode-container .title-icon-container {
    display: flex;
    flex-direction: row;
    align-items: center;
    gap: 5px;
}
.modes .missing-mode-container .title-icon-container i {
    font-size: 1.8rem;
}
