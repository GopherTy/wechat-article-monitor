...
function getDisplayComments(task: CommentMonitorTask): Comment[] {
...
export async function generateMonitorHtml(task: CommentMonitorTask): Promise<string> {
...
export async function generateMonitorMarkdown(task: CommentMonitorTask): Promise<string> {
